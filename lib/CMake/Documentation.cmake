    ...
    if (DOXYGEN_FOUND)
      ...
      message(STATUS ${PROJECT_OUTPUT_NAME})
    	...
    	set(DOCUMENTATION_COMMAND ${DOXYGEN_EXECUTABLE}
                                ${CMAKE_CURRENT_BINARY_DIR}/doc/Doxyfile-html)
        ...
        if (PDFLATEX_COMPILER AND LATEX_COMPILER)
            ...
            if (NOT TARGET "packages_doc_pdf")
                add_custom_target(packages_doc_pdf)
            endif()

            # Add the dependency ${PROJECT_OUTPUT_NAME}_package_doc_pdf to the target 'package_doc_pdf'
            add_dependencies(packages_doc_pdf ${PROJECT_OUTPUT_NAME}_package_doc_pdf)
